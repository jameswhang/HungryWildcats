...
' class="img-circle" width="60px" height="60px"></img></div><div class="col-xs-9 col-sm-6 col-md-6 menu-name"><span>' + 
item['quantity'] + ' order(s) of ' + item['name'] + '</span></div>' + 
//'<span class="menu-quantity"> ' + item['quantity'] + '</span>'
'<div class="col-xs-9 col-sm-6 col-md-6">from <span class="restaurant">' + item['where'] + '</span></div>' +
